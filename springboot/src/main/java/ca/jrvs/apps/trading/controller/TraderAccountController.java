...
public class TraderAccountController {
    ...
    @ApiOperation(value = "Create a trader and an account with DTO", notes = "TraderId and AccountId are auto generated by the database, and the should be the same")
    @ResponseStatus(HttpStatus.CREATED)
    @ResponseBody
    ...
    notes = "Deposit a fund to the account that associates with the give traderId.")
    @ApiResponses(value = {
    ...
    @ApiOperation(value = "Withdraw a fund",
            notes = "Withdraw a fund to the account that associates with the give traderId.")
    @ApiResponses(value = {
            @ApiResponse(code = 404, message = "traderId is not found"),
            @ApiResponse(code = 400, message = "Unable to deposit due to user input")})
    @ResponseStatus(HttpStatus.OK)
